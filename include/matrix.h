...
#define INSTANTIATION_MATRIX_FUNCTIONS(Type1, Type2) \
	template Matrix<Type1>::Matrix(const Matrix<Type2>&); \
    ...
    template auto Matrix<Type1>::element_wise_product(const Matrix<Type2>&) const->Matrix<std::common_type_t<Type1, Type2>>; \
